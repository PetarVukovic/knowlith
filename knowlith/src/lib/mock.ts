...
Ne procjenjuje cijenu koje nema u cjeniku i ne interpolira između dvije stavke. Ako stavka ne postoji, vrati što nedostaje.`,
    ...
    confidence: 0.91,
    decidedBy: "Ana Kovač",
    draftedFrom: { type: "depends_on", targetId: "process:sales.quote", targetTitle: "Izrada ponude" },
    version: 2,
...
5. Ostavi mjesto za potpis servisera i predstavnika naručitelja.`,
    ...
    confidence: 0.86,
    decidedBy: "Marko Babić",
    draftedFrom: { type: "depends_on", targetId: "process:service.intervention", targetTitle: "Servisni nalog" },
    version: 1,
